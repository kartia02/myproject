...
2. **직접 기록 시작**: 하루 단위 기록을 브라우저에 저장합니다. 첫 기록일부터 오늘까지 누락된 날짜를 알려주며, 해당 날짜를 눌러 지난 기록을 보완할 수 있습니다. 서로 다른 날짜의 기록이 37일 이상 모이면 최초 30일을 Baseline, 마지막 7일을 비교 구간으로 분석합니다.
